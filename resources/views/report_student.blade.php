    ...
    <main>
      <div class="min-h-screen bg-gray-100 flex items-start justify-center">
        <div class="w-full max-w-7xl bg-white shadow-lg rounded-lg mt-6 p-6">
          <h2 class="text-lg font-semibold text-gray-900 mb-4">Student Report</h2>
          <table class="table-auto w-full border-collapse border border-gray-200">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border border-gray-300 px-4 py-2 text-left text-gray-700">Class</th>
                    <th class="border border-gray-300 px-4 py-2 text-left text-gray-700">Contact</th>
                  </tr>
            </thead>
            <tbody>
                    ...
                    <td class="border border-gray-300 px-4 py-2">08957689488</td>
                  </tr>
                  <tr>
                    <td class="border border-gray-300 px-4 py-2">2</td>
                    <td class="border border-gray-300 px-4 py-2">Lala</td>
                    <td class="border border-gray-300 px-4 py-2">102</td>
                    <td class="border border-gray-300 px-4 py-2">0890989408</td>
                  </tr>
            </tbody>
          </table>
        </div>
