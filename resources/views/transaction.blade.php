                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/home"
                                    ...
                                    aria-current="page">Report Loans</a>
                                <a href="/report_student" class="rounded-md px-3 py-2 text-sm font-medium text-white"
                                    aria-current="page">Report Student</a>
                                <a href="/books"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Books</a>
                                <a href="/student"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Student</a>
                                <a href="/transaction"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Transaction</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
                        ...
                        <tbody>
                            ...
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">{{ $transaction->book_title }}</td>
                                    <td class="border border-gray-300 px-4 py-2">{{ $transaction->borrowed_at }}</td>
                                    <td class="border border-gray-300 px-4 py-2">{{ $transaction->returned_at }}</td>
